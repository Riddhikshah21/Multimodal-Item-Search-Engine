...
Embedding Generation: OpenCLIP converts images and text into 512-dimensional vectors in a shared embedding space
...
Ranking: Top-k most similar items are returned based on distance metrics
